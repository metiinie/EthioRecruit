    ...
    async createAdmin(agencyId: string, dto: CreateCandidateDto) {
        ...
        const candidate = await this.prisma.candidate.create({
            data: {
                ...
                fullNameAmharic: dto.fullNameAmharic,
                ...
                overseasDetails: dto.overseasDetails,
                localExperienceDetails: dto.localExperienceDetails,
                ...
                fullBodyPhotoUrl: dto.fullBodyPhotoUrl,
                videoUrl: dto.videoUrl,
                passportCopyUrl: dto.passportCopyUrl,
                medicalCertUrl: dto.medicalCertUrl,
                cocCertUrl: dto.cocCertUrl,
                skills: dto.skills || [],
