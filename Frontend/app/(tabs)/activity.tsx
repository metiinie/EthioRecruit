    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.emptyState}>
                <Ionicons name="documents-outline" size={56} color={Colors.gray300} />
                <Text style={styles.emptyTitle}>
                    {isJobSeeker ? 'No applications yet' : 'No inquiries yet'}
                </Text>
                <Text style={styles.emptyDesc}>
                    {isJobSeeker
                        ? 'Your job applications will be tracked here'
                        : 'Your candidate inquiries will appear here'}
                </Text>
            </View>
        </View>
    );
